...
- [x] **Phase 1: 代码整合** - 渲染层与数据层统一，为后续建设打好地基
- [x] **Phase 2: 统一号池** - 构建支持全类型账号的号池核心数据模型与管理界面
- [x] **Phase 3: 注册流水线** - 批量注册自动入池，状态实时可见
- [x] **Phase 4: 绑卡激活** - 批量绑卡自动更新池中状态
- [x] **Phase 5: 网关动态路由** - 网关从号池分配账号，报错即切
- [x] **Phase 6: 异常恢复** - 异常账号自动探测、分类、恢复
- [x] **Phase 7: 全局仪表盘** - 一眼掌控号池、网关、异常全局状态
...
**Plans**: 3 plans
Plans:
- [x] 01-01-PLAN.md — Data service layer (accountService + gatewayDataService)
- [x] 01-02-PLAN.md — Renderer module extraction from renderer.js
- [x] 01-03-PLAN.md — js/ and ui/ migration + index.html cleanup
...
**Plans**: 2 plans
Plans:
- [x] 02-01-PLAN.md — PoolService + SQLite migration v2 + IPC handlers (TDD)
- [x] 02-02-PLAN.md — Pool UI renderer with account cards, filters, and actions
**UI hint**: yes
...
**Plans**: 1 plan
Plans:
- [x] 03-01-PLAN.md — Registration auto-add to pool
**UI hint**: yes
...
**Plans**: 1 plan
Plans:
- [x] 04-01-PLAN.md — Bind card button and tags
**UI hint**: yes
...
**Plans**: 1 plan
Plans:
- [x] 05-01-PLAN.md — Pool-to-channel bridge
...
**Plans**: 1 plan
Plans:
- [x] 06-01-PLAN.md — Error recovery service
...
**Plans**: 1 plan
Plans:
- [x] 07-01-PLAN.md — Dashboard renderer
**UI hint**: yes
...
|-------|---------------|--------|-----------|
| 1. 代码整合 | 3/3 | Complete | 2026-03-27 |
| 2. 统一号池 | 2/2 | Complete | 2026-03-27 |
| 3. 注册流水线 | 1/1 | Complete | 2026-03-27 |
| 4. 绑卡激活 | 1/1 | Complete | 2026-03-27 |
| 5. 网关动态路由 | 1/1 | Complete | 2026-03-27 |
| 6. 异常恢复 | 1/1 | Complete | 2026-03-27 |
| 7. 全局仪表盘 | 1/1 | Complete | 2026-03-27 |
