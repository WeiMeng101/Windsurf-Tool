...
/**
 * Windsurf 路径检测器 — 路径方法委托给 WindsurfPathService，
 * 保留进程管理方法（启动 / 关闭 / 检测运行状态）
 */
class WindsurfPathDetector {
  /** @deprecated 请直接使用 WindsurfPathService.getHomeDir() */
  static getHomeDir() { return WindsurfPathService.getHomeDir(); }
  /** @deprecated 请直接使用 WindsurfPathService.getAppDataDir() */
  static getAppDataDir() { return WindsurfPathService.getAppDataDir(); }
  /** @deprecated 请直接使用 WindsurfPathService.getDBPath() */
  static getDBPath() { return WindsurfPathService.getDBPath(); }
  /** @deprecated 请直接使用 WindsurfPathService.getDataDir() */
  static getUserDataPath() { return WindsurfPathService.getDataDir(); }
  /** @deprecated 请直接使用 WindsurfPathService.getLocalStatePath() */
  static getLocalStatePath() { return WindsurfPathService.getLocalStatePath(); }
  /** @deprecated 请直接使用 WindsurfPathService.getStorageJsonPath() */
  static getStorageJsonPath() { return WindsurfPathService.getStorageJsonPath(); }
...
class AccountSwitcher {
  /**
   * 使用 refresh_token 获取 Firebase tokens（委托给 FirebaseAuthService）
   */
  static async getFirebaseTokens(refreshToken) {
    const { FirebaseAuthService } = require('../services/firebaseAuth');
    return FirebaseAuthService.refreshToken(refreshToken);
  }
