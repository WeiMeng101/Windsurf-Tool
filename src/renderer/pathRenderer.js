...
module.exports = {
  ...
  windowExports: {
    FilePathManager,
    loadFilePaths: () => FilePathManager.loadFilePaths(),
    copyPath: (inputId) => FilePathManager.copyPath(inputId),
    openFolder: (inputId) => FilePathManager.openFolder(inputId),
    openFile: (inputId) => FilePathManager.openFile(inputId),
  },
};
